...
#This function does the straight AL toxics analysis. It is for the parameters that have non-calculated standards, and do not
...
tox_AL_data <- function(database){
  ...
  Results_censored <- censor_data(Results_import, criteria_col = censored_crit ) %>%
